...
<html class="no-js" lang="">
    ...
    <body class="hero">
        ...
        <div class="row hero-session">
        <form class="form-horizontal col-xs-12 col-sm-6 formbox" role="form" name="login" method="post" data-toggle="validator" action="LoginControl">
            <div class="form-group">
                <label class="control-label col-xs-2" for="uname"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
                <div class="col-xs-10">
            ...
            <div class="signup col-xs-12 col-sm-6">
                <p>If it's your first time, Sign Up here.</p>
                <p>It's free and will always be.</p>    
                <a href="signup.html">  
                <input class="sbut" type="button" value="Sign Up">
                </a>
            </div>
        </div>
        </div>
		...
		<div class="stext">
        <center>        
        <p style="color:red;">  INVALID - USERNAME OR PASSWORD INCORRECT  </p>   
        </center>
        </div>
