...
<p class="text-center vtxt1"> LIST OF AVAILABLE STOCKS FROM NASDAQ (USA)
</p>
<p class="text-center vtxt2"> ALL PRICE VALUES IN (USD)
</p>
	 ...
	 <a style="text-decoration:none;" data-toggle="collapse" data-parent="#accordion" href="#${count}">
      ...
      <div id="${count}" class="panel-collapse collapse in">
        <div class="panel-body">
          ...
          <p>Unit Price : $ <span><c:out value="${row.price}"/></span></p>
