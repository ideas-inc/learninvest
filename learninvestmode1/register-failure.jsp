...
<html class="no-js" lang="">
    ...
    <body class="hero">
        ...
        <div class="stext">
        <center>
        <p style="color:red;">  INVALID - USERNAME ALREADY EXISTS  </p>
        </center>
        </div>

        <div>
        <form class="form-horizontal col-xs-offset-2 col-xs-8 formbox" role="form" name="login" method="POST" data-toggle="validator" action="RegisterControl">
