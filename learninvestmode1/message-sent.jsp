...
<body>
	    ...
	    <div class="stext">
        <center>        
        <p style="color:green;">  Message recorded and sent successfully  </p>   
        <a href="admin-dash.jsp"><input class="bbut" style="font-size:20px;" type="button" value="Admin Dashboard"></a>
        </center>
        </div>
