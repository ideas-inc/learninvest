...
<meta charset="utf-8">
    ...
    <title>Change Stock Price</title>
...
<div class="container">
<form method="get" action="ChangeStockPrice" class="formbox2">
<label for="ticker"> Choose Stock :  
</label>
<select name="ticker">
...
<label for="newPrice">Enter new price (INR) :</label> <input type="number" step="0.001" min="0.000" name="newPrice" required>
<br/><br/>
<input type="submit" value="Change Stock Price" class="bbut">    
</form>
</div>
