...
<body>
	    ...
	    <div class="stext">
        <center>        
        <p style="color:green;">  Some form details have been filled incorrectly  </p> 
		<p > Please remember: </p>
		<ol>
        <li > Mobile number must have 10 digits </li>
		<li > Password must have at least 8 characters </li>
		<li > Re entered password must be equal to original password </li>
		</ol>
